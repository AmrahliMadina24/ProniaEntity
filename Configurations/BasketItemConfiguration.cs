...
{
    public class BasketItemConfiguration : IEntityTypeConfiguration<BasketItemConfiguration>
    {
        public void Configure(EntityTypeBuilder<BasketItemConfiguration> builder)
        {
